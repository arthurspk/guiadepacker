# Como contribuir com o Guia de Packer
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique. Se for pago, diga isso na descrição.
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-curso-packer`).
2. Edite o `README.md`.
